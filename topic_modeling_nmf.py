...
def main(reset_cache: bool = False):
    ...
    for n_topics in TOPIC_LIST:
        ...
        # Apply cleaning only to string/object columns to avoid issues
        obj_cols = meta_df_expanded.select_dtypes(include=[object]).columns
        for col in obj_cols:
            meta_df_expanded[col] = meta_df_expanded[col].apply(_clean_text_value)
